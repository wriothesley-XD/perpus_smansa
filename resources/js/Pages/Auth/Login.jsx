    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit} className="mt-8 space-y-5">
                ...
                <div>
                    <div className="flex items-center justify-between mb-1.5">
                        ...
                        {canResetPassword && (
                            <Link href={route('password.request')} className="text-xs font-semibold text-[#123B5D] dark:text-blue-400 hover:underline">
                                Lupa kata sandi?
                            </Link>
                        )}
                    </div>
                ...
                <label className="flex items-center gap-2.5 cursor-pointer">
                    <input
                        ...
                        className="size-4 rounded border-slate-300 text-[#123B5D] focus:ring-[#123B5D]"
                    />
            ...
            <p className="mt-8 text-center text-sm text-slate-500 dark:text-slate-400">
                Belum punya akun?{' '}
                <Link href={route('register')} className="font-semibold text-[#123B5D] dark:text-blue-400 hover:underline">
                    Daftar sekarang
                </Link>
            </p>
        </GuestLayout>
