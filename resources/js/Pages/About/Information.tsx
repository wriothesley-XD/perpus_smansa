        ...
        <SiteShell>
            ...
            <section className="paper-grain relative px-6 py-8 sm:px-10 overflow-hidden">
                <div className="mx-auto max-w-7xl">
                    ...
                    <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                        <div>
                            ...
                            <h1 className="mt-2 font-display text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#0F172A] leading-tight">
                                ...
                                <span className="text-[#FF8E4F]">tumbuh.</span>
                            </h1>
                    ...
                    <div className="mt-12">
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-4 sm:grid-cols-4">
                            <div className="bg-white rounded-lg p-4 border border-[#EDE7DF] shadow-xs flex items-center gap-3">
                                <span className="grid size-9 place-items-center rounded-full bg-[#e8f1f5] text-[#152238]"><Landmark size={17} /></span>
                                <div>
                            ...
                            <div className="bg-white rounded-lg p-4 border border-[#EDE7DF] shadow-xs flex items-center gap-3">
                                <span className="grid size-9 place-items-center rounded-full bg-[#f8f0d5] text-[#152238]"><BookOpen size={17} /></span>
                                <div>
                            ...
                            <div className="bg-white rounded-lg p-4 border border-[#EDE7DF] shadow-xs flex items-center gap-3">
                                <span className="grid size-9 place-items-center rounded-full bg-[#f8e6df] text-[#152238]"><DoorOpen size={17} /></span>
                                <div>
                            ...
                            <div className="bg-white rounded-lg p-4 border border-[#EDE7DF] shadow-xs flex items-center gap-3">
                                <span className="grid size-9 place-items-center rounded-full bg-[#e6eee3] text-[#152238]"><Trophy size={17} /></span>
                                <div>
                    ...
                    <div className="mt-10">
                        ...
                        <div className="mt-3 grid grid-cols-2 gap-4 sm:grid-cols-4">
                            <div className="bg-white rounded-lg p-3 border border-[#EDE7DF] flex items-center gap-2.5 text-xs font-semibold text-slate-700">
                                <BookOpen size={16} className="text-[#152238]" /> <span>Ruang Baca</span>
                            </div>
                            <div className="bg-white rounded-lg p-3 border border-[#EDE7DF] flex items-center gap-2.5 text-xs font-semibold text-slate-700">
                                <Laptop size={16} className="text-[#152238]" /> <span>E-Katalog</span>
                            </div>
                            <div className="bg-white rounded-lg p-3 border border-[#EDE7DF] flex items-center gap-2.5 text-xs font-semibold text-slate-700">
                                <Newspaper size={16} className="text-[#152238]" /> <span>E-Magazine</span>
                            </div>
                            <div className="bg-white rounded-lg p-3 border border-[#EDE7DF] flex items-center gap-2.5 text-xs font-semibold text-slate-700">
                                <Wifi size={16} className="text-[#152238]" /> <span>WiFi Gratis</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="relative mt-12 overflow-hidden rounded-2xl bg-[#152238] p-6 text-white sm:p-8">
                        ...
                        <div className="relative grid gap-8 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
                            ...
                            <div className="relative rounded-xl border border-white/20 bg-white/10 p-5"><div className="flex items-center gap-3"><span className="grid size-12 place-items-center rounded-full bg-[#FFC533] text-[#152238]"><Trophy size={22} /></span><div><p className="font-mono-display text-[10px] font-bold uppercase tracking-wider text-blue-200">Milestone</p><h3 className="font-display text-xl font-bold">Juara Nasional</h3><p className="text-xs text-blue-100">Sekitar 2020 • Program Perpustakaan Sekolah</p></div></div><div className="mt-5 border-t border-white/15 pt-4 text-xs leading-relaxed text-blue-100">Prestasi ini menjadi halaman penting dalam perjalanan kami—dan alasan untuk terus membuat ruang baca yang lebih terbuka, kreatif, dan relevan.</div></div>
                        </div>
                    </div>
