    ...
    return (
        <SiteShell>
                ...
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 sm:px-8">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 rounded-xl bg-[#152238] px-3 py-1.5 text-xs font-bold text-white hover:bg-[#0f172a] transition-colors"
                        >
            ...
            <div className="mx-auto max-w-7xl px-6 py-8 sm:px-8">
                <div className="mb-6">
                    <span className="font-mono-display text-[10px] font-bold uppercase tracking-widest text-[#152238]">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4 sm:grid-cols-4">
                            {otherEditions.map((item) => (
                                ...
                                >
                                    ...
                                    <h3 className="mt-2 font-display text-xs font-bold text-[#0F172A] group-hover:text-[#152238] line-clamp-1">
                                        {item.edition_title}
                                    </h3>
