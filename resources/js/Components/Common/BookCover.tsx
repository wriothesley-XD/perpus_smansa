...
export function BookCover({ src, title, className = '' }: BookCoverProps) {
    ...
    if (failed || !src) {
        return (
            <div
                className={`relative flex flex-col items-center justify-center overflow-hidden rounded-xl bg-gradient-to-br from-[#123B5D] to-[#092E61] p-4 text-center text-white shadow-md ${className}`}
            ...
            >
                ...
                <span className="mt-2 text-[9px] font-semibold uppercase tracking-widest text-[#F8D77E]">
                    SMAN 1 Bukittinggi
                </span>
            </div>
        );
